...
<div class="row row-overflow">
	...
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<legend><i class="fas fa-table"></i> {{Mes Compteur}}</legend>
		<?php
		if (count($eqLogics) == 0) {
			echo '<br><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucun équipement SmartMeterUSB trouvé, cliquer sur "Ajouter" pour commencer}}</div>';
		} else {
			// Champ de recherche
					...
					<fieldset>
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="eqLogicAttr form-control" data-l1key="logicalId" placeholder="{{Numéro compreur}}">
								</div>
							</div>
						</div>
					...
					<table id="table_cmd" class="table table-bordered table-condensed">
						<thead>
							<tr>
								...
								<th style="width:120px">{{LogicalId}}</th>
...
<?php include_file('desktop', 'SmartMeterUSB', 'js', 'SmartMeterUSB'); ?>
